 ...
 */
function Tarea({ titulo, descripcion = null, estado = Estado.PENDIENTE, vencimiento = null, dificultad = Dificultad.FACIL }) {
...
Tarea.prototype.actualizar = function({ descripcion, estado, dificultad, vencimiento }) {
  ...
  // - Si input === "" => mantener
  // - Si input === " " (un espacio) => setear null
...
ToDoApp.prototype.seedDemo = async function() {
  // ... (código original sin cambios) ...
